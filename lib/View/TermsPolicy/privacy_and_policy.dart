...
import 'package:revamp_eperpus_mobile/View/TermsPolicy/TermsPolicyView.dart';
...
class PrivacyAndPolicyView extends StatefulWidget {
  String locale;
  PrivacyAndPolicyView({Key? key, required this.locale}) : super(key: key);
                      ...
                      ? () async {
                          if (Platform.isIOS) {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => TemsAndPolicyView(
